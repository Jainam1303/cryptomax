...
export const calculateProfitLoss = (investment) => {
...
export const generatePriceMovement = (basePrice, volatility = 0.05, trend = 0) => {
...
export const generatePriceHistory = (basePrice, dataPoints = 24, volatility = 0.05, trend = 0) => {
  const priceHistory = [];
